...
namespace WorkItemManagement.UnitTests.ModelsTests.WorkItemTests
{
    ...
    public class Constructor_Should : Cleaner
    {
        ...
        {
            new Feedback("1", null, 3, "This is a feedback created");
        }
        ...
        {
            new Feedback("1", new string('a', 9), 3, "This is a feedback created");
        }
        ...
        {
            new Feedback("1", new string('a', 51), 3, "This is a feedback created");
        }
        ...
        {
            new Feedback(null, "TheFirstFeedback", 3, "This is a feedback created");
        }
        ...
        {
            new Feedback("1", "TheFirstFeedback", 3, null);
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void MinLength_Description()
        {
            new Feedback("1", "TheFirstFeedback", 3, new string('a', 9));
        }
        ...
        {
            new Feedback("1", "TheFirstFeedback", 3, new string('a', 501));
        }
